...
USERS_TABLE_NAME = os.environ.get('USERS_TABLE_NAME', 'CinemaPulseUsers')
MOVIES_TABLE_NAME = os.environ.get('MOVIES_TABLE_NAME', 'CinemaPulseMovies')
REVIEWS_TABLE_NAME = os.environ.get('REVIEWS_TABLE_NAME', 'CinemaPulseReviews')
FEEDBACK_TABLE_NAME = os.environ.get('FEEDBACK_TABLE_NAME', 'CinemaPulseFeedback')
